...
#include <barabot_bt/pid_bel.hpp>
#include <cmath>
float max = 1;
float min = -1;
float kp = 1;
...
public:
        ...
        : BT::StatefulActionNode(name, config)
    {
        ...
        cmd_pub_ = node_->create_publisher<geometry_msgs::msg::Twist>("/diff_cont/cmd_vel_unstamped", 10);
        odom_sub_ = node_->create_subscription<nav_msgs::msg::Odometry>(
            "/diff_cont/odom", 10, std::bind(&GoToPose::odom_callback, this, std::placeholders::_1));
    }
